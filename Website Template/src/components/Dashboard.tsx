      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row gap-8 items-start mb-16">
          <div className="flex-1">
            <h1 className="text-4xl text-white font-light mb-2">Client Dashboard</h1>
          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="bg-zinc-950 border border-white/5 p-8 rounded-3xl">
              <div className="flex items-center gap-3 mb-8">
                ...
                <h2 className="text-white font-bold uppercase tracking-widest text-sm">Upcoming</h2>
              </div>
              <div className="min-h-[160px] flex flex-col items-center justify-center border-2 border-dashed border-white/5 rounded-2xl p-8 text-center bg-black/40">
                <p className="text-white/20 italic mb-4 font-light">No upcoming appointments scheduled.</p>
              </div>
            </div>
            ...
            <div className="bg-zinc-950 border border-white/5 p-8 rounded-3xl">
              <div className="flex items-center gap-3 mb-8">
                ...
                <h2 className="text-white font-bold uppercase tracking-widest text-sm">History</h2>
              </div>
              <div className="min-h-[200px] flex flex-col items-center justify-center border border-white/5 rounded-2xl p-8 bg-black/40">
                <p className="text-white/20 italic font-light">No past appointments found.</p>
              </div>
            </div>
          </div>
